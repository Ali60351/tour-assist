    ...
    <v-container>
      <v-card flat>
        <v-card-text>
          ...
          <br/>
          <h1 class="text-xs-center" style="font-size: 1.5em"> {{ 'Source: ' + source }} </h1>
          <h1 class="text-xs-center" style="font-size: 1.5em"> {{ 'Destination: ' + destination }} </h1>
          <h1 class="text-xs-center" style="font-size: 1.5em"> {{ 'Class: ' + this.class }} </h1>
          <h1 class="text-xs-center" style="font-size: 1.5em"> {{ 'Price: ' + price }} </h1>
          <br/>
